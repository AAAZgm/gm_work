...
#CH9102，同时系统没有安装对应驱动 串口号0001 设置别名为wheeltec_lidar，用串口号区分
echo  'KERNEL=="ttyACM*", ATTRS{idVendor}=="1a86", ATTRS{idProduct}=="55d4",ATTRS{serial}=="5A6D014210", MODE:="0777", GROUP:="dialout", SYMLINK+="gm_laser"' >/etc/udev/rules.d/wheeltec_lidar3.rules
