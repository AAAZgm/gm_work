...
#ifndef FISHBOT_INTERFACES__SRV__DETAIL__FISH_BOT_CONFIG__FUNCTIONS_H_
#define FISHBOT_INTERFACES__SRV__DETAIL__FISH_BOT_CONFIG__FUNCTIONS_H_
...
/// Initialize srv/FishBotConfig message.
/**
...
/// Finalize srv/FishBotConfig message.
/**
...
/// Create srv/FishBotConfig message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * fishbot_interfaces__srv__FishBotConfig_Request__init().
...
/// Destroy srv/FishBotConfig message.
/**
 * It calls
 * fishbot_interfaces__srv__FishBotConfig_Request__fini()
...
/// Check for srv/FishBotConfig message equality.
/**
...
/// Copy a srv/FishBotConfig message.
/**
...
/// Initialize array of srv/FishBotConfig messages.
/**
...
/// Finalize array of srv/FishBotConfig messages.
/**
 * It calls
 * fishbot_interfaces__srv__FishBotConfig_Request__fini()
...
/// Create array of srv/FishBotConfig messages.
/**
 * It allocates the memory for the array and calls
 * fishbot_interfaces__srv__FishBotConfig_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/FishBotConfig messages.
/**
 * It calls
 * fishbot_interfaces__srv__FishBotConfig_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/FishBotConfig message array equality.
/**
...
/// Copy an array of srv/FishBotConfig messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * fishbot_interfaces__srv__FishBotConfig_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_fishbot_interfaces
...
/**
 * It calls
 * fishbot_interfaces__srv__FishBotConfig_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_fishbot_interfaces
...
/**
 * It allocates the memory for the array and calls
 * fishbot_interfaces__srv__FishBotConfig_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_fishbot_interfaces
...
/**
 * It calls
 * fishbot_interfaces__srv__FishBotConfig_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // FISHBOT_INTERFACES__SRV__DETAIL__FISH_BOT_CONFIG__FUNCTIONS_H_
